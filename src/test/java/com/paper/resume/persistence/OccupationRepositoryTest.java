...
public class OccupationRepositoryTest {
    ...
    public void RegisterOccupationTest2(){
        ...
        occupation.setParentOccupation(occupationRepo.findByName("IT"));
        occupationRepo.save(occupation);

        Occupation occupation1 = new Occupation();
        occupation1.setName("시스템 개발");
        occupation1.setParentOccupation(occupationRepo.findByName("개발"));
        occupationRepo.save(occupation1);

        assertEquals(occupationRepo.findByName("개발").getParentOccupation().getId(), occupationRepo.findByName("IT").getId());
    }
    ...
    public void RegisterOccupationTest3(){
        ...
        occupation.setParentOccupation(occupationRepo.findByName("개발"));
